package DP;//把数字翻译成字符串(0-25翻译成a-z)
//
//    自上而下，从最大的问题开始，递归 ：
//            12258
//            /       \
...
public class DP_P231_TranslateNumbersInToStrings {
    //动态规划，从右到左计算。
    ...
    public static  int getTranslationCount(int num){
        ...
        return getTranslationCount1(String.valueOf(num));
    }

    public static int getTranslationCount1(String str) {
        int f1 = 1;
        int f2 = 1;
        int g = 0;
        int temp;

        //除去两个初始值：保证最后一位也可以使用公式
